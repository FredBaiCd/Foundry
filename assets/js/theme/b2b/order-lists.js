...
export default function(context) {
	...
	const initPage = function() {
		...
		if (gRoleId == "0") {
	    	...
	    	<div class="filter-by-date">
	    	    <span style="display:inline-block;">From: <input type="text" id="orderFromDate" readOnly /></span> 
	    	    <span style="display:inline-block;"> To: <input type="text" id="orderToDate" readOnly /></span>
		...
		`);
			...
			<div class="table-toolbar top">
	    		<div class="action-links">
	    			<a class="action-link button button--small button--secondary" href="javascript:void(0);" filter-user data-user-value="0" style="display:none;">Show All Company Orders</a>
	    			<a class="action-link button button--small button--secondary" href="javascript:void(0);" filter-user data-user-value="1">Show My Orders</a>
	    		</div>
	    	</div>
	    	<h3 class="account-heading">Orders</h3>
	    	<div class="filter-by-date">
	...
	const initDatePicker = function() {
		...
		let defaultStartDate = new getStoreZoneDate();
		let defaultEndDate = new getStoreZoneDate();
		let startMinDate = new getStoreZoneDate();
	...
	const openCreateShoppingListModal = function(orderId) {
		...
		newListModal = new Modal({
			el: $('#modal-new-shopping-list-order'),
			modalClass: 'modal--small'
		});
		newListModal.$el.html(`
		    ...
		    <div class="modal-body">
		        <form class="form b2b-form-wrap" id="new_shopping_list_form" action="" method="post" data-order-id="${orderId}">
