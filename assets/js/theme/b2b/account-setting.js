...
export default function(customer) {
	...
	const $accountForm = $("form.account-settings-form");

	$accountForm.addClass("b2b-account-setting-form").prepend(`<div class="form-field b2b-account-form-heading" >Account Information</div><div class="form-field b2b-account-form-heading" ></div>`);
	...
	const $accountCompany = $accountForm.find('[name="account_companyname"]').parents(".form-field");
	const $accountPassword = $accountForm.find('[data-field-type="Password"]').parents(".form-field");

	if ($accountCompany.length > 0) {
		$accountCompany.hide();
		$accountForm.append($accountCompany);
	}
	if ($accountPassword.length > 0) {
		$('<div class="form-field b2b-account-form-heading" >Password Reset</div><div class="form-field b2b-account-form-heading" ></div>').insertBefore($accountPassword);
	}
