  ...
  if (this.context.customer && this.context.customer != null) {
        ...
        success: (data) => {
          ...
          if (company_status && company_status == "APPROVED") {
            ...
            if (company_status == "PENDING" || company_status == "REJECTED") {
              ...
              $(".header-tools-inner").prepend(`<li class="header-tools-item">
                      <a class="" href="/trade-professional-application/"><span class="label">Trade Professional Application</span></a>
                  </li>`);
            } else {
    ...
    const handleRoleId = function() {
      ...
      if (bundleb2b_user.role_id == "0") {
        ...
        $(".form-actions[data-product-add]").hide();
        ...
        $(".header-tools-inner").prepend(`<li class="header-tools-item navUser-item--quickorder">
                      <a href="/quick-order-pad/"><span class="label">Quick Order Pad</span></a>
                  </li>`);
        const hurl = document.referrer;
        if (hurl.indexOf("/login.php") != -1) {
          $(".body").remove();
        ...
        $(".account-nav .account-nav-list").prepend(`<li class="account-nav-item">
                <a class="account-nav-link" href="/salerep/">Dashboard</a>
            </li>`);
      ...
      // b2b search
      $('input[name="search_query"]').parents("form").attr("action", "/b2b-search");
    ...
    const handleCatalogProducts = function() {
      ...
      for (var product_id in catalog_products) {
        ...
        if ($(`${productSelector}`).length > 0) {
          ...
          if (catalog_price) {
            ...
            $(`${productSelector}`).find(".product-price [data-product-price]").text("$" + priceStyle(catalog_price, 2));
          }
        }
      }
      ...
      $homeCatalogProducts.each(function() {
        if ($(this).find("[catalog-product='true']").length == 0) {
      ...
      $productCarousel.each(function() {
        $(this).slick('slickFilter', '[catalog-product="true"]');
    ...
    const initCompanyMessage = function() {
      if (sessionStorage.getItem("bundleb2b_sale")) {
        ...
        $(".header-topbar").after(`<div class="salerep-infobox"><div class="page-container" style="overflow:hidden;"><span style="line-height:40px;">Viewing as ${company_name}</span><span class="button button--primary" style="float:right;margin: 0;" end-masquerade>End Masquerade</span></div></div>`);
