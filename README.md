...
Pixel Union's Settings documentation for this theme can be found [here](https://www.pixelunion.net/support/foundry-theme-manual/).

This theme comes with four design presets:
[Classic](https://foundry-classic-demo.mybigcommerce.com),
[Light](https://foundry-light-demo.mybigcommerce.com),
[Moody](https://foundry-moody-demo.mybigcommerce.com),
[Warm](https://foundry-warm-demo.mybigcommerce.com).
